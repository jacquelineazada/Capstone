    ...
    <v-main class="bg-grey-lighten-3">
      <v-container fluid class="px-4 mx-auto" style="max-width: 900px">
        ...
        <v-card class="my-2 pa-4 a4-paper">
          <v-card-text>
            <div id="electronics-permit-form-page-1">
              <div class="header-section">
                <div class="form-no">NBC FORM No. A-07</div>
              ...
              <div class="permit-title-section">
                <div class="permit-title">ELECTRONICS PERMIT</div>
              </div>
              ...
              <div class="box-container">
                ...
                <div class="scope-of-work-section-image">
                  <p class="scope-of-work-label">SCOPE OF WORK</p>
                  <div class="scope-options">
                    ...
                    <div class="scope-option other-option">
                      <v-checkbox
                        dense
                        hide-details
              ...
              <div class="mt-2">
                ...
                <div class="box-container box-2-new-format">
                  <p class="box-label">
                    NATURE OF INSTALLATION WORKS/EQUIPMENT SYSTEM:
                  </p>
                  <div class="box-content-new-format">
                    <div class="box-2-option-column">
                      <v-checkbox
                        dense
                        hide-details
                      ...
                      <v-checkbox
                        dense
                        hide-details
                        label="SECURITY AND ALARM SYSTEM"
                      ></v-checkbox>
                    </div>
                    <div class="box-2-option-column">
                      <v-checkbox
                    ...
                    <div class="other-electronics-specify">
                      <p class="specify-label">
                        ANY OTHER ELECTRONICS AND IT SYSTEMS, EQUIPMENT,
                        APPARATUS, DEVICE AND/OR COMPONENT (Specify
                      </p>
                      <span class="underline flex-grow-1"></span>
              ...
              <div class="box-3-4-wrapper mt-2">
                ...
                <div class="info-box-wrapper">
                  ...
                  <div class="info-box">
                    ...
                    <div class="signature-caption-area">
                      <p class="font-weight-bold mb-0">ELECTRONICS ENGINEER</p>
                      <p class="caption-text">
                        (Signed and Sealed Over Printed Name)
                      </p>
                    </div>
        ...
        <v-card class="my-4 pa-4">
          <v-card-text>
            <div id="electronics-permit-form-page-2">
              ...
              <div class="box-7-container">
                <div class="architectural-documents-section">
                  <p class="documents-title">
                    FIVE (5) SETS OF ELECTRONICS DOCUMENTS
                  </p>
                  <div class="documents-grid">
                    <div class="documents-col">
                      <v-checkbox
                        dense
                        hide-details
                        label="1. ELECTRONICS PLANS AND SPECIFICATIONS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="2. BILL OF MATERIALS"
                      ></v-checkbox>
                    </div>
                    <div class="documents-col">
                      <v-checkbox
              ...
              <div class="box-8-container">
                ...
                <div class="box-8-cell label-cell">ELECTRONICS</div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
              ...
              <div class="box-9-container">
                ...
                <ol class="conditions-list">
                  ...
                  <li>
                    That the proposed electronics works shall be in accordance
                    with the electronics plans filed with this Office and in
                    conformity with the latest provisions of the Philippine
                    Electronics Code, the National Building Code and its IRR.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    of Completion stating that the electronics works conform to
                    the provision of the Philippine Electronics Code, the
...
#electronics-permit-form-page-1,
#electronics-permit-form-page-2 {
...
.scope-option .v-checkbox {
  margin: -8px 0;
  padding-top: 0;
  padding-bottom: 0;
  flex-shrink: 0;
}
.scope-option :deep(label) {
  font-size: 9pt !important;
  white-space: nowrap;
}
.scope-option.other-option {
  align-items: flex-end;
  flex: 1.5;
}
.scope-option.other-option .underline {
  margin-bottom: 2px;
  flex-grow: 1;
  margin-left: 4px;
}
...
.box-2-new-format > .box-label {
  border-bottom: 2px solid black;
  margin-bottom: 0;
}
.box-content-new-format {
  display: grid;
...
.box-2-option-column .v-checkbox {
  margin: -8px 0;
  padding-top: 0;
  padding-bottom: 0;
}
.box-2-option-column :deep(label) {
  font-size: 9pt !important;
}
...
.other-electronics-specify .specify-label {
  font-size: 9pt;
  font-weight: bold;
  margin-bottom: 4px;
  display: flex;
...
.other-electronics-specify .underline {
  margin-left: 4px;
  margin-bottom: 2px;
}
.prepared-by-section {
