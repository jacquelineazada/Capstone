          ...
          <v-card-text>
            <div id="architectural-permit-form-page-1">
              <div class="header-section">
                <div class="form-no">NBC FORM NO. A-01</div>
              ...
              <div class="permit-title-section">
                <div class="permit-title">ARCHITECTURAL PERMIT</div>
              </div>
              ...
              <div class="box-container">
                ...
                <div class="scope-section-wrapper">
                  ...
                  <div class="scope-grid">
                    <div class="scope-col">
                      <div class="scope-item">
                        ...
                        ></v-checkbox
                        ><span class="underline scope-line"></span>
                      </div>
                      <div class="scope-item">
                        <v-checkbox
                          dense
                    ...
                    <div class="scope-col">
                      ...
                      <div class="scope-item">
                        ...
                        ></v-checkbox
                        ><span class="underline scope-line-long"></span>
                      </div>
                      <div class="scope-item">
                        <v-checkbox
                          dense
                ...
                <div class="box-content">
                  <div class="facilities-section">
                    <p class="section-title">
                      1. ARCHITECTURAL FACILITIES AND OTHER FEATURES...
                    </p>
                    <div class="facilities-grid">
                      ...
                      <v-checkbox
                        dense
                        hide-details
                        label="SWITCHES, CONTROLS, BUZZERS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                      ...
                      <v-checkbox
                        ...
                        label="CORRIDORS"
                      ></v-checkbox>
                      <v-checkbox dense hide-details label="RAMPS"></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="THRESHOLDS"
                      ...
                      <v-checkbox
                        dense
                        hide-details
                        label="DOORS, ENTRANCES & THRESHOLDS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                  ...
                  <div class="bottom-sections-wrapper">
                    <div class="percentage-section">
                      ...
                      <div class="percentage-field">
                        <span>PERCENTAGE OF BUILDING FOOTPRINT</span
                        ><span class="underline flex-fill"></span><span>%</span>
                      </div>
                      <div class="percentage-field">
                        <span>PERCENTAGE OF IMPERVIOUS SURFACE AREA</span
                        ><span class="underline flex-fill"></span><span>%</span>
                      </div>
                      <div class="percentage-field">
                        <span>PERCENTAGE OF UNPAVED SURFACE AREA</span
                        ><span class="underline flex-fill"></span><span>%</span>
                      </div>
                    </div>
                    <div class="fire-code-section">
                      <p class="section-title">
                        3. CONFORMANCE TO FIRE CODE OF THE PHILIPPINES (P.D.
                        1185)
                      </p>
                      <div class="fire-code-grid">
                        <v-checkbox
                          dense
                          hide-details
              ...
              <div class="box-3-4-wrapper mt-2">
                <div class="info-box-wrapper">
                  ...
                  <div class="info-box">
                    ...
                    <div class="signature-caption-area">
                      <p class="font-weight-bold mb-0">ARCHITECT</p>
                    ...
                    <div class="details-table">
                      ...
                      <div class="detail-row">
                        <span class="detail-label">IAPOA No.</span>
                      </div>
                      <div class="detail-row">
                        <span class="detail-label">Validity</span>
                      </div>
                      <div class="detail-row">
                        <span class="detail-label">PRC No.</span>
                      </div>
                      <div class="detail-row">
                        <span class="detail-label">Validity</span>
                      </div>
                      <div class="detail-row">
                        <span class="detail-label">PTR. No</span>
                      </div>
                      <div class="detail-row">
                ...
                <div class="info-box-wrapper">
                  ...
                  <div class="info-box">
                    <p class="info-box-title">
                      SUPERVISOR / IN-CHARGEOFF ARCHITECTURAL WORKS
                    </p>
                    <div class="signature-area">
                      <div class="signature-line-main"></div>
                      <div class="signature-line-date">Date</div>
              ...
              <div class="box-5-6-wrapper mt-2">
                <div class="info-box-wrapper">
                  ...
                  <div class="owner-box">
                    ...
                    <div class="owner-details">
                      <div class="owner-detail-row full-width">Address</div>
                      <div class="owner-detail-row">
                        <div class="owner-detail-col">C.T.C. No.</div>
                        <div class="owner-detail-col">Date Issued</div>
                        <div class="owner-detail-col">Place Issued</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <v-card class="my-4 pa-4 a4-paper">
          <v-card-text>
            <div id="architectural-permit-form-page-2">
              ...
              <p class="box-label-outer">BOX 7</p>
                  ...
                  <div class="documents-grid">
                    <div class="documents-col">
                      <v-checkbox
                        dense
                        hide-details
                        label="1. VICINITY MAP/LOCATION PLAN WITHIN A TWO-KILOMETER RADIUS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="2. SITE DEVELOPMENT PLAN"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                      ...
                      <v-checkbox
                        dense
                        hide-details
                        label="5. ELEVATIONS, AT LEAST FOUR (4)"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="6. SECTIONS, AT LEAST TWO (2)"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="7. CEILING PLANS SHOWING LIGHTING FIXTURES AND DIFFUSERS"
                      ></v-checkbox>
                    </div>
                    <div class="documents-col">
                      <v-checkbox
                        dense
                        hide-details
                        label="8. DETAILS OF RAMPS, PARKING FOR THE DISABLED, STAIRS, FIRE ESCAPES, CABINETS AND PARTITIONS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="9. SCHEDULE OF DOORS AND WINDOWS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="10. SCHEDULE OF FINISHES FOR FLOORS, CEILINGS AND WALLS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="11. ARCHITECTURAL INTERIOR"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="12. SPECIFICATIONS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                        label="13. COST ESTIMATE"
                      ></v-checkbox>
                      <div class="other-docs-item">
                        <v-checkbox
                          dense
                          hide-details
                          label="14. OTHERS (Specify)"
                        ></v-checkbox>
              ...
              <div class="box-8-container">
                ...
                <div class="box-8-cell label-cell">ARCHITECTURAL DRAWINGS</div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell label-cell">SPECIFICATIONS</div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
              ...
              <div class="box-9-container">
                ...
                <ol class="conditions-list">
                  <li>
                    ...
                    Philippines, the architect (and engineer) who drew up the
                    plans and specifications for the building/structure is
                    responsible for damages if within fifteen (15) years from
                    the completion of the building/structure, the same should
                    collapse due to defect in the plans or specifications or
                    defects in the ground. The engineer or architect who
                    supervises the construction shall be solidarily liable with
                    the contractor should the edifice collapse due to defect in
                    the construction or the use of inferior materials.
                  </li>
                  <li>
                    That the proposed architectural works shall be in accordance
                    with the architectural plans filed with this Office and in
                    conformity with the latest Architectural Code of the
                  ...
                  <li>
                    ...
                    of Completion stating that the architectural works conform
                    to the provision of the Architectural Code, the National
...
.facilities-grid .v-checkbox,
.fire-code-grid .v-checkbox {
  margin: -8px 0;
}
