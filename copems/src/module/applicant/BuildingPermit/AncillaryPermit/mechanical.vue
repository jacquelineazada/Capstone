    ...
    <v-main class="bg-grey-lighten-3">
      <v-container fluid class="px-4 mx-auto" style="max-width: 900px">
          ...
          <v-card-text>
            <div id="mechanical-permit-form-page-1">
              <div class="header-section">
                <div class="form-no">NBC FORM NO. A - 04</div>
              ...
              <div class="permit-title-section">
                <div class="permit-title">MECHANICAL PERMIT</div>
              </div>
              ...
              <div class="box-container mt-2">
                ...
                <div class="box-content">
                  <div class="pa-3">
                    ...
                    <div class="mechanical-works-grid">
                      <div class="mechanical-works-col">
                        <v-checkbox
                          dense
                          hide-details
                          label="BOILER"
                        ...
                        <v-checkbox
                          dense
                          hide-details
                          label="PACKAGED/ SPLIT TYPE AIRCONDITIONING"
                        ></v-checkbox>
                        <div class="scope-item">
                          <v-checkbox
                            dense
                      ...
                      <div class="mechanical-works-col">
                        ...
                        <v-checkbox
                          dense
                          hide-details
                          label="COMPRESSED AIR, VACUUM, INSTITUTIONAL and/or INDUSTRIAL GAS"
                        ></v-checkbox>
                        <v-checkbox
                          dense
                          hide-details
        ...
        <v-card class="my-4 pa-4">
          <v-card-text>
            <div id="civil-structural-permit-form-page-2">
...
.mechanical-works-grid {
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  gap: 16px;
}
.mechanical-works-col {
  display: flex;
  flex-direction: column;
  gap: 4px;
}
.mechanical-works-col .v-checkbox {
  margin: -8px 0;
}
.mechanical-works-col :deep(label) {
  font-size: 9pt !important;
}
.prepared-by-section {
  display: flex;
