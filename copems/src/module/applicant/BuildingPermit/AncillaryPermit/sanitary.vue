    ...
    <v-main class="bg-grey-lighten-3">
      <v-container fluid class="px-4 mx-auto a4-container">
        <v-card class="my-2 pa-4">
          <v-card-text>
            <div id="sanitary-permit-form-page-1">
              <div class="header-section">
                <div class="form-no">NBC FORM NO. A-05</div>
              ...
              <div class="permit-title-section">
                <div class="permit-title">SANITARY PERMIT</div>
              </div>
              ...
              <p class="box-label-outer mt-2">
                BOX 2 (TO BE ACCOMPLISHED BY THE DESIGN PROFESSIONAL)
              </p>
              <div class="box-container">
                <div class="pa-3">
                  <p class="section-title">INSTALLATION AND OPERATION OF:</p>
                  <div class="box2-grid">
                    <div class="box2-col">
                      <p class="box2-col-title">WATER SUPPLY:</p>
                      <v-checkbox
                        dense
                        hide-details
                        label="SHALLOW WELL"
                    ...
                    <div class="box2-col">
                      <p class="box2-col-title">SYSTEM OF DISPOSAL:</p>
                      <v-checkbox
                        dense
                        hide-details
                    ...
                    <div class="box2-col">
                      <p class="box2-col-title" style="visibility: hidden">
                        &nbsp;
                      </p>
                      <v-checkbox
                        dense
                  ...
                  <div class="info-box">
                    ...
                    <div class="designation-checkboxes">
                      <v-checkbox
                        dense
                        hide-details
                        label="PROFESSIONAL MECHANICAL ENGINEER"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
        ...
        <v-card class="my-4 pa-4">
          <v-card-text>
            <div id="sanitary-permit-form-page-2">
                  ...
                  <div class="documents-grid">
                    <div class="documents-col">
                      <v-checkbox
                        dense
                        hide-details
                        label="1. MECHANICAL DESIGNS COMPUTATIONS, PLANS AND SPECIFICATIONS"
                      ></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
              ...
              <div class="box-8-container">
                ...
                <div class="box-8-cell label-cell">MECHANICAL</div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
                <div class="box-8-cell"></div>
              ...
              <div class="box-9-container">
                ...
                <ol class="conditions-list">
                  ...
                  <li>
                    That the proposed mechanical works shall be in accordance
                    with the mechanical plans filed with this Office and in
                    conformity with the latest Mechanical Code of the
                  ...
                  <li>
                    ...
                    of Completion stating that the mechanical works conform to
                    the provision of the Mechanical Code, the National Building
                    Code and its IRR.
                  </li>
                  <li>
...
#sanitary-permit-form-page-1,
#sanitary-permit-form-page-2 {
...
.designation-checkboxes .v-checkbox {
  margin: -8px 0;
}
.designation-checkboxes :deep(label) {
  font-size: 9pt !important;
}
