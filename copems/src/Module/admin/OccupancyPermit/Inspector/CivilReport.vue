...
const checklistItems = ref([
  { label: "Application for Building Permit", remarkLabel: "Enter remarks..." },
  { label: "Scaffolding & Sidewalk", remarkLabel: "Enter remarks..." },
  {
    label: "Safety Requirements for Construction/Demolition",
  ...
  { label: "Structural Hazards", remarkLabel: "Enter remarks..." },
]);
