...
const checklistItems = ref([
  { label: "General Requirements", remarkLabel: "Enter remarks..." },
  { label: "Services, Feeders & Branch Circuits", remarkLabel: "Enter remarks..." },
  { label: "Hazardous Locations", remarkLabel: "Enter remarks..." },
  {
    label: "Swimming Pools & Related Installations",
    remarkLabel: "Enter remarks...",
  },
  { label: "Emergency & Standby Systems & Fire Pumps", remarkLabel: "Enter remarks..." },
  { label: "General Wiring Method", remarkLabel: "Enter remarks..." },
  { label: "Grounding & Bonding", remarkLabel: "Enter remarks..." },
  { label: "Special Occupancies", remarkLabel: "Enter remarks..." },
]);
