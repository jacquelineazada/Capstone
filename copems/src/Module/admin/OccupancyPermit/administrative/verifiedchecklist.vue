        ...
        <v-card :style="s.dialogCard">
          ...
          <v-card-text class="pt-4">
            ...
            <p v-if="allRequirementsChecked" class="font-weight-medium text-success">
                            All {{ checklistItems.length }} requirements have been checked
              and               confirmed.            
            </p>
                       
          ...
          <v-card-text class="pt-4">
            ...
            <v-form @submit.prevent="submitReturn">
              ...
              <v-label :style="s.inputLabel">
                ...
                <span class="text-red-darken-1">*</span>              
              </v-label>
                           
              <v-textarea
          ...
          <v-col cols="12" md="5">
            ...
            <v-card class="elevation-2" :style="s.enhancedChecklistCard">
              ...
              <v-card-title :style="s.cardTitleEnhanced">
                ...
                >
                                   
                  {{ allRequirementsChecked ? "Verified" : uncheckedCount + " Pending" }}
                                 
                </v-chip>
                             
              </v-card-title>
              ...
              <v-card-text class="pt-4 pb-2 px-4">
                ...
                >
                  ...
                  <div class="d-flex align-start">
                    ...
                    >
                                           
                      {{ item.checked ? "mdi-check-circle" : "mdi-alert-circle" }}        
                                 
                    </v-icon>
                                       
                    <span
                      :style="
                        item.checked ? s.checklistLabelChecked : s.checklistLabelUnchecked
                      "
                    >
                                            {{ item.label }}                    
                    </span>
                  ...
                  <v-expand-transition>
                                       
                    <div
                      v-if="item.isCommentable && item.checked"
                      class="pl-7 pr-3 pt-2 pb-1"
                    >
                                           
                      <v-label :style="s.inputLabel" class="text-caption">
                                                Details:                      
                      </v-label>
                                           
                      <p class="text-body-2 font-weight-medium" style="color: #374151">
                                                {{ item.comment || "N/A" }}              
                               
                      </p>
                                         
...
const checklistItems = ref([
  ...
  { label: "Sketch map indicating the location of the project;", checked: true },
  {
    label: "Others: ",
    checked: true,
    isCommentable: true,
    comment: "Submitted latest version of the site plan and structural analysis.",
  },
]);
...
const confirmVerification = () => {
  console.log("Application Verified (Function stub)");
...
const submitReturn = () => {
  console.log("Application Returned (Function stub)");
